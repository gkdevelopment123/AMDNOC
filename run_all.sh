...
pkill -9 -f "admin_panel" 2>/dev/null
pkill -9 -f "app.py" 2>/dev/null
fuser -k -9 8001/tcp 8002/tcp 8080/tcp 8090/tcp 7860/tcp 2>/dev/null
sleep 4
...
python admin_panel.py > /tmp/admin.log 2>&1 &
sleep 4
echo "==> Health checks:"
...
curl -s http://localhost:8090/       >/dev/null && echo "   admin  :8090  OK" || echo "   admin  :8090  FAIL"
echo ""
echo "==> ITSM board:  https://notebooks.amd.com/jupyter-hack-team-3049-260614162200-ee4e0c4e/proxy/8080/"
echo "==> Admin panel: https://notebooks.amd.com/jupyter-hack-team-3049-260614162200-ee4e0c4e/proxy/8090/"
echo ""
